...
\newcommand{\aufgaben}[2]{
  ...
  \fancyhead[C]{\textbf{Aufgaben}\\\textbf{Kapitel #1}}
  \fancyhead[R]{#2}
  ...
  \hypersetup{
    ...
    pdftitle={\module: Aufgaben Kapitel #1},
    pdfsubject={Aufgaben aus Kapitel #1, #2},
    pdfkeywords={Aufgaben, \module},
...
\aufgaben{1.4 und 1.5.1}{Logik}

%--- Footer -
\newcommand{\lastMod}{
    \Filemodtoday{\filemodNewest{
        {Aufgaben_1.4.tex}{Aufgaben_1.5.1.tex}
    }}
}
\date{\lastMod{}}
